    ...
    <ul class="previews-list slides">
          ...
          $image_title = esc_html($attributes['title']);                 
              $image_title = esc_html($attributes['title']);
                     ...
                     $html  = '<li><a href="' . esc_url(  $image_link) . '" class="cloud-zoom-gallery" title="'.$image_title.'" rel="'.$rel.'" data-image="'.$image_link.'" data-zoom-image="'.$image_link.'" href="' . esc_url(  $image_link ) . '">';
                    $html .=$image ;
                    $html .= '</a></li>';
                   $loop++;
