						...
						<?php if( is_shop() ) { ?>
							<div class="shop-desc <?php echo esc_attr($shoplayout);?>"> 
								<div class="shop_header">   
									<?php if( isset($devita_opt['bg_shop']['url']) && $devita_opt['bg_shop']['url']!=''){ ?>
										<div class="bg-shop"><img src="<?php echo esc_url($devita_opt['bg_shop']['url'])?>" /></div>
									<?php } ?> 
								</div> 
							</div>
									...
									<?php if ( woocommerce_products_will_display() ) { ?>
										<div class="toolbar">
											<div class="toolbar-inner">  
												...
												?> 
												<div class="view-mode">
													<label><?php esc_html_e('View on', 'devita');?></label>
													<a href="#" class="grid <?php if($devita_viewmode=='grid-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'Grid', 'devita' ); ?>"> <?php echo esc_attr__( 'Grid', 'devita' ); ?></a>
													<a href="#" class="list <?php if($devita_viewmode=='list-view'){ echo ' active';} ?>" title="<?php echo esc_attr__( 'List', 'devita' ); ?>"> <?php echo esc_attr__( 'List', 'devita' ); ?></a>
												</div>
