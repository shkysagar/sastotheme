...
function magikCreta_grid_list_trigger()
{
    ...
    <div class="sorter">
        <div class="view-mode">
            <a href="#" class="grid-trigger button-active button-grid">grid</a>
            <a href="#" title="<?php esc_attr_e('List', 'creta'); ?>" class="list-trigger  button-list">list</a>
        </div>
    </div>
    <?php
...
function magikCreta_woocommerce_header_add_to_cart_fragment($fragments)
{
    ...
    $fragments['.cart-menu-btn'] = ob_get_clean();
...
function magikCreta_hotdeal_timer_js()
{
    ...
    <script type="text/javascript">
        jQuery('.timer-grid').each(function(){
           ...
           jQuery(this).countdown(countTime,function(event){jQuery(this).html('<div class="day col-3"><span>'+event.strftime('%D')+'</span> days</div> <div class="hour col-3"><span>'+event.strftime('%H')+'</span>hrs</div><div class="min col-3"><span>'+event.strftime('%M')+' </span>mins</div> <div class="sec col-3"><span>'+event.strftime('%S')+'</span> sec</div>')});
