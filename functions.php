...
class MagikCreta {
    ...
    */
    ...
    function magikCreta_scripts_styles()
    {
        ...
        wp_enqueue_style('bootstrap.min', MAGIKCRETA_THEME_URI . '/src/css/bootstrap.min.css', array(), '');
        ...
        wp_enqueue_style('electro', MAGIKCRETA_THEME_URI . '/src/css/font-electro.css', array(), '');
...
//        }
        ...
        wp_enqueue_script('cart', MAGIKCRETA_THEME_URI . '/src/js/common.js', array('jquery'), '', true);
        wp_enqueue_script('countdown', MAGIKCRETA_THEME_URI . '/src/js/countdown.js', array('jquery'), '', true);
