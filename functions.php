...
class MagikCreta
{
    ...
    */
    ...
    function magikCreta_scripts_styles()
    {
        ...
        wp_enqueue_style('bootstrap.min', MAGIKCRETA_THEME_URI . '/src/css/bootstrap.css', array(), '');
        wp_enqueue_style('stylesheet', MAGIKCRETA_THEME_URI . '/src/css/styles.css', array(), '');
...
//        wp_enqueue_script('jquery.min-js', MAGIKCRETA_THEME_URI . '/src/js/jquery.min.js', array('jquery'), '', true);
        wp_enqueue_script('popper.min-js', MAGIKCRETA_THEME_URI . '/src/js/popper.min.js', array('jquery'), '', true);
        wp_enqueue_script('bootstrap.min-js', MAGIKCRETA_THEME_URI . '/src/js/bootstrap.min.js', array('jquery'), '', true);
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <?php if (sizeof(WC()->cart->get_cart()) > 0) : $i = 0; ?>
                                <ul class="mini-products-list d-none" id="cart-sidebar">
