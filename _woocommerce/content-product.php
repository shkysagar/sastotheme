                        ...
                        <ul class="add-to-links pull-left-none">
                            ...
                            if (class_exists('YITH_Woocompare_Frontend')) {
                                ...
                                <li class="pull-left-none"><a class="compare add_to_compare_small link-compare"
                                                ...
                                                class="fa fa-signal icons"></i></a></li>
                                <?php
                            }
                            ?>
                            ...
                            <?php if (class_exists('YITH_WCQV_Frontend')) { ?>
                                <li class="link-view pull-left-none">
                                    <div class="product-detail-bnt">
                                        ...
                                        <a title="<?php esc_attr_e('Quick View', 'creta'); ?>"
                                           class="yith-wcqv-button quickview link-quickview button detail-bnt"
                                           data-product_id="<?php echo esc_html($product->get_id()); ?>"><span><?php esc_attr_e('Quick View', 'creta'); ?></span></a>
                                    </div>
                                </li>
                        ...
                        <ul class="add-to-links">
                            ...
                            <?php if (class_exists('YITH_WCQV_Frontend')) { ?>
                                <li>
                                    ...
                                    <a title="<?php esc_attr_e('Quick View', 'creta'); ?>"
                                       class="yith-wcqv-button quickview link-quickview"
                            ...
                            if (isset($yith_wcwl) && is_object($yith_wcwl)) {
                                ...
                                <li>
                                    <a href="<?php echo esc_url(add_query_arg('add_to_wishlist', $product->get_id())) ?>"
                                       data-product-id="<?php echo esc_html($product->get_id()); ?>"
                                       data-product-type="<?php echo esc_html($product->get_type()); ?>" <?php echo htmlspecialchars_decode($classes); ?>
                                       title="<?php esc_attr_e('Add to WishList', 'creta'); ?>"><?php esc_attr_e('Add to WishList', 'creta'); ?></a>
                                </li>
                                <?php
                            }
                            ?>
                            ...
                            if (class_exists('YITH_Woocompare_Frontend')) {
                                ...
                                $mgk_yith_cmp->add_product_url($product->get_id());
                                ?>
                                <li><a class="compare add_to_compare_small link-compare"
                                       data-product_id="<?php echo esc_html($product->get_id()); ?>"
                                       href="<?php echo esc_url($mgk_yith_cmp->add_product_url($product->get_id())); ?>"
                                       title="<?php esc_attr_e('Add to Compare', 'creta'); ?>"><?php esc_attr_e('Add to Compare', 'creta'); ?></a>
                                </li>
                                <?php
                            }
                            ?>
