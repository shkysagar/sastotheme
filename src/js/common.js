 ...
 */
    (function (jQuery) {
        ...
        if (jQuery.support == undefined) {
            jQuery.support = {opacity: !(jQuery.browser.msie)};
        }
        ...
        function buildOptions(jQuerycont, jQueryslides, els, options, o) {
            ...
            jQuery(els[first]).css("opacity", 1).show();
            ...
            if (reshape) {
                ...
                for (var j = 0; j < els.length; j++) {
                    ...
                    if (!w) {
                        w = e.offsetWidth || e.width || jQuerye.attr("width");
                    }
                    if (!h) {
                        h = e.offsetHeight || e.height || jQuerye.attr("height");
                    }
                    maxw = w > maxw ? w : maxw;
                    maxh = h > maxh ? h : maxh;
                }
            ...
            if (opts.next) {
                jQuery(opts.next).bind(opts.prevNextEvent, function () {
                    return advance(opts, opts.rev ? -1 : 1);
                });
            }
            if (opts.prev) {
                jQuery(opts.prev).bind(opts.prevNextEvent, function () {
                    return advance(opts, opts.rev ? 1 : -1);
                });
            }
            if (opts.pager || opts.pagerAnchorBuilder) {
        ...
        function go(els, opts, manual, fwd) {
            ...
            if ((manual || !p.cyclePause) && (opts.nextSlide != opts.currSlide)) {
                ...
                if (opts.fxFn) {
                    ...
                    if (jQuery.isFunction(jQuery.fn.cycle[opts.fx])) {
        ...
        jQuery.fn.cycle.createPagerAnchor = function (i, el, jQueryp, els, opts) {
            ...
            if (!/^click/.test(opts.pagerEvent) && !opts.allowPagerClickBubble) {
                jQuerya.bind("click.cycle", function () {
                    return false;
                });
            }
            if (opts.pauseOnPagerHover) {
                jQuerya.hover(function () {
                    opts.jQuerycont[0].cyclePause++;
                }, function () {
                    opts.jQuerycont[0].cyclePause--;
                });
            }
        ...
        jQuery.fn.cycle.custom = function (curr, next, opts, cb, fwd, speedOverride) {
            ...
            var fn = function () {
                jQueryn.animate(opts.animIn, speedIn, easeIn, cb);
            };
