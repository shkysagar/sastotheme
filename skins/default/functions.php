        ...
        if (isset($creta_Options['enable_header_language']) && ($creta_Options['enable_header_language'] != 0)) { ?>
            <div class="dropdown block-language-wrapper">
                <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/english.png"
                         alt="<?php esc_attr_e('English', 'creta'); ?>">
                    <?php esc_attr_e('English', 'creta'); ?><span class="caret"></span>
                </a>
                <ul class="dropdown-menu" role="menu">
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img
                                    src="<?php echo esc_url(get_template_directory_uri()); ?>/images/english.png"
                                    alt="<?php esc_attr_e('English', 'creta'); ?>"> <?php esc_attr_e('English', 'creta'); ?>
                        </a></li>
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img
                                    src="<?php echo esc_url(get_template_directory_uri()); ?>/images/francais.png"
                                    alt="<?php esc_attr_e('French', 'creta'); ?>"> <?php esc_attr_e('French', 'creta'); ?>
                        </a></li>
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#"><img
                                    src="<?php echo esc_url(get_template_directory_uri()); ?>/images/german.png"
                                    alt="<?php esc_attr_e('German', 'creta'); ?>"> <?php esc_attr_e('German', 'creta'); ?>
                        </a></li>
                </ul>
            </div>
            <?php
    ...
    function magikCreta_recentitem_template()
    {
        ...
        <div class="item col-md-4 col-lg-3 col-xl-3">
            <div class="box_grid">
                ...
                <ul>
                    <li>
                        <span class="price"><?php echo htmlspecialchars_decode($product->get_price_html()); ?></span>
                    </li>
                    <li>
                        <div class="score"><span class="d-none">Superb<em>350 Reviews</em></span>
                            <?php if ($product->is_on_sale()) : ?>
                                <strong><?php esc_attr_e('Sale', 'creta'); ?></strong>
                            <?php endif; ?>
                        </div>
                    </li>
                </ul>
                ...
                <section class="add_bottom_45">
                    <div class="main_title_2">
                        ...
                        if (isset($creta_Options['enable_home_featured_products-text']) && isset($creta_Options['enable_home_featured_products-heading'])) { ?>
                            <span><em></em></span>
                            <h2><?php echo htmlspecialchars_decode($creta_Options['enable_home_featured_products-heading']); ?></h2>
                            <p><?php echo htmlspecialchars_decode($creta_Options['enable_home_featured_products-text']); ?></p>
                            <?php
                        }
                        ?>
                    </div>
                                ...
                                <div class="bottom-banner-img1 last">
                                    ...
                                    <a href="<?php echo !empty($creta_Options['home-sub-banner5-url'])
                                        ...
                                        <img src="<?php echo esc_url($creta_Options['home-sub-banner5']['url']); ?>"
                                             alt="<?php esc_attr_e('offer banner', 'creta'); ?>"> <span
                            ...
                            <div id="new-arrivals-slider" class="product-flexslider hidden-buttons">
                                <div class="home-block-inner">
                                    ...
                                    <a class="view_more_bnt"
                                       href="<?php echo !empty($creta_Options['enable_home_recommended_products']) ? esc_url($creta_Options['recommended_product_url']) : '#' ?>"><?php esc_attr_e('VIEW ALL ', 'creta'); ?></a>
                                </div>
                        ...
                        <div class="bestsell-block">
                            <div id="bestsell-slider" class="product-flexslider hidden-buttons">
                                ...
                                <div class="home-block-inner">
                                    ...
                                    <a class="view_more_bnt"
                                       href="<?php echo !empty($creta_Options['enable_home_bestseller_products']) ? esc_url($creta_Options['bestseller_product_url']) : '#' ?>"><?php esc_attr_e('VIEW ALL', 'creta'); ?></a>
                                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    foreach ($creta_Options['home_newproduct_categories'] as $catcontent) {
                        ...
                        <div class="tab-pane show fade <?php if ($contentloop == 1) { ?> active <?php } ?>"
                            ...
                            <div id="carousel-<?php echo esc_html($contentloop); ?>" class="owl-carousel owl-theme">
                                <?php
                                $args = array(
                                    'post_type' => 'product',
                                    'post_status' => 'publish',
    ...
    function magikCreta_productitem_template()
    {
        ...
        <div class="item ">
            <div class="box_grid">
                ...
                <ul>
                    <li><?php echo htmlspecialchars_decode($product->get_price_html()); ?></li>
                    <li>
                        <div class="score">
                            <?php $MagikCreta->magikCreta_woocommerce_product_add_to_cart_text(); ?>
                        </div>
                            ...
                            <div class="rating">
                                <div class="ratings">
                                    <div class="rating-box">
                                        ...
                                        <div class="rating"
                                             style="width:<?php echo esc_html(($average / 5) * 100); ?>%"></div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="blog-outer-container">
                            <div class="new_title">
                                <h2>
                                    <strong> <?php esc_attr_e('Latest', 'creta'); ?> </strong><?php esc_attr_e('Blog', 'creta'); ?>
                                </h2>
                                    ...
                                    while ($the_query->have_posts()) : $the_query->the_post(); ?>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 blog-preview_item">
                                            ...
                                            <div class="blog-preview_info">
                                                <ul class="post-meta">
                                                    <li>
                                                        <i class="fa fa-user"></i><?php esc_attr_e('By', 'creta'); ?>  <?php the_author(); ?>
                                                    </li>
                                                    <li><i class="fa fa-comment"></i><a
                                                                href="<?php comments_link(); ?>"><?php comments_number('0 Comment', '1 Comment', '% Comments'); ?>
                                                        </a></li>
                                                    <li><i class="fa fa-calendar"></i>
                                                        <time class="entry-date"
                                                              datetime="2015-05-11T11:19:34+00:00"><?php esc_html(the_time('F d, Y')); ?></time>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="blog-preview_desc">
                                                    <div class="homeblog"><?php the_excerpt(); ?></div>
                                                </div>
                                                <a class="blog-preview_btn"
                                                   href="<?php the_permalink(); ?>"><?php esc_attr_e('Read more', 'creta'); ?></a>
                                            </div>
