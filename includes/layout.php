    ...
    function magikCreta_top_navigation()
    {
        ...
        if (isset($creta_Options['login_button_pos']) && $creta_Options['login_button_pos'] == 'toplinks') {
            ...
            if (is_user_logged_in()) {
                ...
                $html .= '<li class="nav-item"><a class="nav-link" href="' . esc_url($logout_link) . '">' . esc_html__('Logout', 'creta') . '</a></li>';
            } else {
                ...
                $html .= '<li class="nav-item"><a class="nav-link" href="' . esc_url($login_link) . '"> ' . esc_html__('Login & Register', 'creta') . '</a></li>';
            }
        }
